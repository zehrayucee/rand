    ...
    if (form1 != undefined ) {
      ...
      [].slice.call(form1.getElementsByTagName("input")).map((item, count) => {
        if (item.value == ""   ) {
          ...
          disabled = 3
          document.getElementById("inputdeneme").classList.remove("is-invalid");
        } 
          else {
                      ...
                      <div className="form1 mlk">
                        <Form className="register">
                          <Container>
                            ...
                            <div className="ta" >
                              <Button className="btn-round mr-1 mra btn-lg" color="dark" type="button" onClick={this.handlesubmit22}>
                                <i class="fas fa-chevron-left"></i>&nbsp;&nbsp;Önceki
                                  </Button>
